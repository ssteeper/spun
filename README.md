...
**Hortophora transmarina.** First plate: its straight-sided, nearly even frame and crowded hub made the mesh read too architectural and the free zone too narrow. The next passes displaced the flank and lower anchors, widened the free zone from 64 to 76 px, and reduced the target spoke range; the re-rendered plate shows a larger irregular frame with deflected radius feet (maximum 5.0 px), warm tapering twig supports and an open hub annulus. The dense upper rows and longer lower turns remain a visible consequence of asymmetric radial lengths, not separately drawn shapes.
